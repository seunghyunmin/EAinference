...
test_that("pointEstimate length under two types, \"mu\" and \"coeff\"", {
 expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, p-1), sig2_1 = 1, lbd_1 = .5,
                            weights = Weights, group = Group, niter = Niter, type = "grlasso", PEtype = "coeff", parallel = FALSE),
              "pointEstimate must have a same length")
 expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, p), sig2_1 = 1, lbd_1 = .5,
                             weights = Weights, group = Group, niter = Niter, type = "grlasso", PEtype = "coeff", parallel = FALSE)
  , NA)
 expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, p), sig2_1 = 1, lbd_1 = 1,
 ...
 expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, p), sig2_1 = 1, lbd_1 = 1,
              ...
              , NA)
 expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, n-1), sig2_1 = 1, lbd_1 = .5,
                            weights = Weights, group = Group, niter = Niter, type = "grlasso", PEtype = "mu", parallel = FALSE),
              "pointEstimate must have a same length")
 expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, n), sig2_1 = 1, lbd_1 = .5,
                            weights = Weights, group = Group, niter = Niter, type = "grlasso", PEtype = "mu", parallel = FALSE)
              , NA)
 expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, n), sig2_1 = 1, lbd_1 = .5,
...
test_that("missing parameter", {
  expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, p), sig2_1 = 1,
                             weights = Weights, group = Group, niter = Niter, type = "grlasso", PEtype = "coeff", parallel = FALSE)
...
test_that("Improper value of parameter, sig2/lbd/weights", {
  ...
  expect_error(PBsampler(X = x, pointEstimate_1 = rep(0, p), sig2_1 = c(1,2), lbd_1 = .5,
                             weights = Weights, group = Group, niter = Niter, type = "grlasso", parallel = FALSE),
...
if(.Platform$OS.type != "windows"){
  test_that("parallel", {
    expect_warning(PBsampler(X = x, pointEstimate_1 = rep(0, p), sig2_1 = 1, lbd_1 = .5,
