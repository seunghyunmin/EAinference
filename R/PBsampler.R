...
#' only if mixture distribution is used.
...
#' If \code{Btype = "wild"}, we further multiply \code{error_new} with the residuals.
#' Then, if \code{PEtype = "coeff"}, \code{y_new} is generated by \code{X * PE + error_new}
#' and if \code{PEtype = "mu"}, \code{y_new} is \code{PE + error_new}.
#'
#' By providing \code{(PE_2, sig2_2, lbd_2)}, users can use a mixture sampling distribution.
